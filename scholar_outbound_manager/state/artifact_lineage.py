        ...
        records.append(
            {
                ...
                "attempt_count": _coerce_optional_int(summary.get("attempt_count")) if isinstance(summary, dict) else None,
                "retries_used": _coerce_optional_int(summary.get("transport_retry_count_used")) if isinstance(summary, dict) else None,
                "warmup_attempts": _coerce_optional_int(summary.get("warmup_attempt_count")) if isinstance(summary, dict) else None,
                "final_attempt_index": _coerce_optional_int(summary.get("final_attempt_index")) if isinstance(summary, dict) else None,
